...
// ============================================
// Address: 1.4
// Purpose: Export all protocol handlers
// ============================================
...
/**
 * All protocol handlers as a map
 */
...
export const ALL_PROTOCOL_HANDLERS = {
...
export type ProtocolHandlerType = keyof typeof ALL_PROTOCOL_HANDLERS;
